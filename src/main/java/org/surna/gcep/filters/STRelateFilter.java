 ...
 * This is just a more generalized method to accomplish the operations that are defined under the JTS
...
public class STRelateFilter
{
    ...
    private static final Log log = LogFactory.getLog(STRelateFilter.class);
	...
	public boolean STRelate( Geometry base, Geometry test, String DE9IM)
	{
		...
		{
			String logStmt = "STRelate is test = " + test.toString() + " test spacially overlaps base = " + base.toText()+" using DE9IM " + DE9IM;
			log.info(logStmt);			
		}
